...
double lower_angle_ = -1.57;
double upper_angle_ = 1.57;
...
void scan_sub_callback(const sensor_msgs::LaserScan& input_scan)
{
...
int main(int argc, char** argv){
  ...
  input_scan_sub = n1.subscribe("/scan", 10, scan_sub_callback);
